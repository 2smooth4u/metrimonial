<%-- 
    Document   : profile
    Created on : 15 Jan, 2021, 12:48:15 AM
    Author     : Yash
--%>
   	 	...
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
                    ...
                    <form method="post" action="imageUpload.jsp" name="uploadForm" ENCTYPE='multipath/form-data'>
<label>Image : </label>
...
<input  type=submit class="btn btn-danger">
			...
			<div class="col-sm-8 row_1">
				...
				<ul class="login_details">
                                    <li>Update Profile? <a href="edit_email.jsp">Update Profile</a></li>
			      <li>Update Password? <a href="changepass.jsp">Change Password</a></li>
                              <li>Logout Profile? <a href="logout.jsp">Logout Profile</a></li>
			    </ul>
			</div>
			<div class="clearfix"> </div>
		</div>

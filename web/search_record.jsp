<%-- 
    ...
    Created on : 15 Jan, 2021, 2:47:46 AM
    Author     : Yash
--%>
                               ...
                               String caste=request.getParameter("caste");
                                String religion=request.getParameter("religion");
                                 ...
                                 if(request.getParameter("id")!=null){
                                     ...
                                     if(id<0){
                                         response.sendRedirect("search.jsp?id=0");
                                     }
                                 }
			int n=3;
                        int start=id*n;
                ...
                ResultSet rs= st.executeQuery("select * from users where gender='"+gender+"' AND religion='"+religion+"' AND caste='"+caste+"' limit "+start+","+n);
                  while(rs.next()){
                    %>
     ...
     <div class="profile_top"><a href="view_profile.php?id=<?=$r["code"]?>
	    	...
	    	<table class="table_working_hours">
	        	<tbody>
	        		<tr class="opened_1">
						...
						<td class="day_value"><% out.print(rs.getString("fname")+" "+rs.getString("lname"));%></td>
					</tr>
				    <tr class="opened">
				    ...
				    <tr class="opened">
						...
						<td class="day_value"><% out.print(rs.getInt("day")+"/"+rs.getInt("month")+"/"+rs.getInt("year")); %></td>
					</tr>
				    <tr class="opened">
	    ...
	    <div class="clearfix"> </div>
                   <% 
                    ...
                    out.print("<a href='search_record.jsp?id="+prev+"&gender="+gender+"&caste="+caste+"&religion="+religion+"'>Previous</a>");
                    %>
                    <br>
                    <%
	       out.print("<a href='search_record.jsp?id="+next+"&gender="+gender+"&caste="+caste+"&religion="+religion+"'>Next</a>");

<%-- 
    Document   : edit_email
    Created on : 15 Jan, 2021, 1:17:51 AM
    Author     : Yash
--%>
  ...
  <div class="container">
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left">
		   ...
		   <h2>Profile Id : <% out.print(rs.getString("code")); %></h2>
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
					 <ul class="slides">
						<li data-thumb="photo/EFVX2l_1.jpg">
							<img src="photo/EFVX2l_1.jpg" />
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><input type="text" name="fname" value="<%out.print(rs.getString("fname"));%>" class="form-control" required></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Last Name :</td>
							<td class="day_value"><input type="text" name="lname" value="<%out.print(rs.getString("lname"));%>" class="form-control" required></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="opened">
							...
							<td class="day_value"><select name="caste" class="form-control" required>
	                    ...
	                    <option value="<%out.print(rs.getString("day"));%>"><%out.print(rs.getString("day"));%></option>
	                    ...
	                    <option  value="<%out.print(rs.getString("month"));%>"><%out.print(rs.getString("month"));%></option>
					...
					%>
	                    ...
	                    <option value="<%out.print(rs.getString("year"));%>"><%out.print(rs.getString("year"));%></option>
	                <%
...
<%
                     ...
                     response.sendRedirect("profil.jsp?invalidemail");
                }
                cn.close();
                }
        catch(Exception e){
